...
// Versãos mais antigas do JavaScrip usa "formato" Require, mas nas versões mais novas usa-se o "formato" Import (VS Code corrige automaticamente, se quiser).
...
// Mesmo que não use um ou outro, o Express exige o "req, res", exatamente nessa ordem.
app.get("/", function (req, res) {
    res.send("Oi, Mundão!");
});

// Rota alternativa (/ola) que tem informação diferente (Olá, Mundo!).
